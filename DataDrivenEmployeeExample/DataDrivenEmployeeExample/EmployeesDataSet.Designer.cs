...
namespace DataDrivenEmployeeExample {
    ...
    public partial class EmployeesDataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public EmployeesRow AddEmployeesRow(string Name, string Title, string Department, System.DateTime HireDate) {
...
namespace DataDrivenEmployeeExample.EmployeesDataSetTableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employees] ([Name], [Title], [Department], [HireDate]) VALUES " +
                "(@Name, @Title, @Department, @HireDate);\r\nSELECT Id, Name, Title, Department, Hi" +
                "reDate FROM Employees WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employees] SET [Name] = @Name, [Title] = @Title, [Department] = @Department, [HireDate] = @HireDate WHERE (([Id] = @Original_Id) AND ([Title] = @Original_Title) AND ((@IsNull_Department = 1 AND [Department] IS NULL) OR ([Department] = @Original_Department)) AND ([HireDate] = @Original_HireDate));
SELECT Id, Name, Title, Department, HireDate FROM Employees WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DataDrivenEmployeeExample.Properties.Settings.Default.EmployeeDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Title, Department, HireDate FROM dbo.Employees";
        ...
        public virtual int Insert(string Name, string Title, string Department, System.DateTime HireDate) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Title, string Department, System.DateTime HireDate, int Original_Id, string Original_Title, string Original_Department, System.DateTime Original_HireDate, int Id) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Title, string Department, System.DateTime HireDate, int Original_Id, string Original_Title, string Original_Department, System.DateTime Original_HireDate) {
            return this.Update(Name, Title, Department, HireDate, Original_Id, Original_Title, Original_Department, Original_HireDate, Original_Id);
        }
    }
